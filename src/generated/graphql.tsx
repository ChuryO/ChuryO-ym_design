...
/** The category type */
export type Category = Node & TermNode & UniformResourceIdentifiable & {
   __typename?: 'Category';
  /**
...
/** The post type */
export type Post = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithContentEditor & NodeWithAuthor & NodeWithFeaturedImage & NodeWithExcerpt & NodeWithComments & NodeWithTrackbacks & NodeWithRevisions & {
   __typename?: 'Post';
  /**
...
/** A User object */
export type User = Node & UniformResourceIdentifiable & {
   __typename?: 'User';
  /**
...
/** The page type */
export type Page = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithContentEditor & NodeWithAuthor & NodeWithFeaturedImage & NodeWithComments & NodeWithRevisions & NodeWithPageAttributes & HierarchicalContentNode & {
   __typename?: 'Page';
  /**
   * The author field will return a queryable User type matching the post&#039;s author.
   * @deprecated 
...
/** The mediaItem type */
export type MediaItem = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithAuthor & NodeWithComments & HierarchicalContentNode & {
...
export enum MediaItemSizeEnum {
  /** MediaItem with the custom-gallery size */
  CustomGallery = 'CUSTOM_GALLERY',
  /** MediaItem with the default-image size */
  DefaultImage = 'DEFAULT_IMAGE',
  /** MediaItem with the img-gallery size */
  ...
  /** MediaItem with the miniatura size */
  Miniatura = 'MINIATURA',
  /** MediaItem with the slider size */
  Slider = 'SLIDER',
...
export type ContentTemplateUnion = DefaultTemplate | HomepageTemplate | SubmenuTemplate;
...
/** The template assigned to the node */
export type HomepageTemplate = ContentTemplate & {
   __typename?: 'HomepageTemplate';
  /**
   * The name of the template
   * @deprecated 
   */
...
/** The template assigned to the node */
export type SubmenuTemplate = ContentTemplate & {
   __typename?: 'SubmenuTemplate';
  /**
   * The name of the template
   * @deprecated 
   */
...
export type MenuItemsQueryVariables = {};
...
export const MenuItemsDocument = gql`
  ...
  menuItems(where: {location: TOP_MENU}) {
    ...
    `;
export type MenuItemsComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<MenuItemsQuery, MenuItemsQueryVariables>, 'query'>;

    export const MenuItemsComponent = (props: MenuItemsComponentProps) => (
      <ApolloReactComponents.Query<MenuItemsQuery, MenuItemsQueryVariables> query={MenuItemsDocument} {...props} />
    );
    
export type MenuItemsProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<MenuItemsQuery, MenuItemsQueryVariables>
    } & TChildProps;
export function withMenuItems<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  MenuItemsQuery,
  MenuItemsQueryVariables,
  MenuItemsProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, MenuItemsQuery, MenuItemsQueryVariables, MenuItemsProps<TChildProps, TDataName>>(MenuItemsDocument, {
      alias: 'menuItems',
      ...operationOptions
    });
};
 ...
 * });
 */
export function useMenuItemsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<MenuItemsQuery, MenuItemsQueryVariables>) {
        return ApolloReactHooks.useQuery<MenuItemsQuery, MenuItemsQueryVariables>(MenuItemsDocument, baseOptions);
      }
export function useMenuItemsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<MenuItemsQuery, MenuItemsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<MenuItemsQuery, MenuItemsQueryVariables>(MenuItemsDocument, baseOptions);
        }
...
export type MenuItemsQueryResult = ApolloReactCommon.QueryResult<MenuItemsQuery, MenuItemsQueryVariables>;